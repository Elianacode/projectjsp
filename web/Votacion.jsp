...
<body onload="carga()" style="background-color:#eeeeee">
    <% //Preguntar por la sesion del usuario votante
        ...
        if (sessionOk.getAttribute("votante") != null) {
            System.out.println(sessionOk.getAttribute("votante"));
            ...
            <div class="input-field col s4 center-align"  style="background-color:#fc7323; z-index: -1;">
                <div class="reloj">
                    <% DAOUsuario daou = new DAOUsuario();
                        String nombre = String.valueOf(sessionOk.getAttribute("votante"));
                        // System.out.println(daou.consultarNombreUsuario(Integer.parseInt(nombre)));
                        String nom = daou.consultarNombreUsuario(nombre).getNombre();
                    %>
                    <span style="font-size:33px"><%=nom%> su tiempo para votar es:</span>
                    <span id="minutos" style="font-size:33px">1</span>:<span id="segundos" style="font-size:33px">60</span></div>
            </div> 
            </font>
        </div>
